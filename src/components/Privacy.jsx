...
export const Privacy = () => {
  return (
    <div class="text-white px-10 pt-24 pb-10 flex flex-col lg:px-20 lg:pt-36 lg:pb-20">
      <h1 class="text-3xl font-bold mb-8">Polityka prywatności</h1>
      <h2 class="text-2xl mt-6 mb-2">1. Informacje ogólne</h2>
      <p>
        Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url:
        wellnesssolutions.pl Operatorem serwisu oraz Administratorem danych
        osobowych jest: WELLNESS SOLUTIONS SPÓŁKA Z OGRANICZONĄ
        ODPOWIEDZIALNOŚCIĄ Ul. Malowany Dworek 45, 43-300 Bielsko Biała Adres
        kontaktowy poczty elektronicznej operatora: hello@wellnesssolutions.pl
        ...
        w następujących celach: Prowadzenie rozmów typu chat online Obsługa
        zapytań przez formularz Realizacja zamówionych usług Serwis realizuje
        funkcje pozyskiwania informacji o użytkownikach i ich zachowaniu w
        następujący sposób: Poprzez dobrowolnie wprowadzone w formularzach dane,
        które zostają wprowadzone do systemów Operatora. Poprzez zapisywanie w
      ...
      <p>
        ...
        użytkownika i mogą być odczytane jedynie na docelowym serwerze. Dane
        osobowe przechowywane w bazie danych są zaszyfrowane w taki sposób, że
        jedynie posiadający Operator klucz może je odczytać. Dzięki temu dane są
        chronione na wypadek wykradzenia bazy danych z serwera. Hasła
        ...
        użytkowników. Operator okresowo zmienia swoje hasła administracyjne. W
      ...
      <h2 class="text-2xl mt-6 mb-2">3. Hosting</h2>
      <p>
        Serwis jest hostowany (technicznie utrzymywany) na serwerach operatora:
        cyberFolks.pl Firma hostingowa w celu zapewnienia niezawodności
        technicznej prowadzi logi na poziomie serwera. Zapisowi mogą podlegać:
        zasoby określone identyfikatorem URL (adresy żądanych zasobów – stron,
        plików), czas nadejścia zapytania, czas wysłania odpowiedzi, nazwę
        stacji klienta – identyfikacja realizowana przez protokół HTTP,
        ...
        informacje diagnostyczne związane z procesem samodzielnego zamawiania
        usług poprzez rejestratory na stronie, informacje związane z obsługą
      ...
      <p>
        ...
        zakresie przetwarzania wskazanego w pkt 3.2 wobec przetwarzania danych
      ...
      <h2 class="text-2xl mt-6 mb-2">5. Informacje w formularzach</h2>
      <p>
      ...
      <h2 class="text-2xl mt-6 mb-2">6. Logi Administratora</h2>
      <p>
      ...
      <h2 class="text-2xl mt-6 mb-2">7. Istotne techniki marketingowe</h2>
      <p>
        ...
        jest włączona obsługa plików cookie. Operator stosuje korzysta z piksela
        Facebooka. Ta technologia powoduje, że serwis Facebook (Facebook Inc. z
        siedzibą w USA) wie, że dana osoba w nim zarejestrowana korzysta z
        ...
        ciasteczek w urządzeniu końcowym użytkownika. Operator stosuje
        rozwiązanie badające zachowanie użytkowników poprzez tworzenie map
        ciepła oraz nagrywanie zachowania na stronie. Te informacje są
        anonimizowane zanim zostaną przesłane do operatora usługi tak, że nie
        wie on jakiej osoby fizycznej one dotyczą. W szczególności nagrywaniu
        nie podlegają wpisywane hasła oraz inne dane osobowe. Operator stosuje
        ...
        konkretnej podstrony, o ile wyraził on zgodę na otrzymywanie
        korespondencji handlowej od Operatora.
      </p>
      <h2 class="text-2xl mt-6 mb-2">8. Informacja o plikach cookies</h2>
      <p>
      ...
      <p>
        ...
        internetową, której używasz i postępuj zgodnie z instrukcjami: Edge
        Internet Explorer Chrome Safari Firefox Opera Urządzenia mobilne:
