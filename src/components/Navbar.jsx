...
export const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile navbar */}
      {isOpen && (
        <div className="flex fixed bottom-0 left-0 flex-col lg:hidden bg-bgDark1 w-full h-screen pt-24 items-center gap-10 pb-10 border-y border-solid border-bgDark3 z-20">
